...
INSERT INTO "new_Project" ("buildingAreaSf", "createdAt", "docsReceived", "earthworkSfPerTrip", "flexibleBaseCap", "flexibleBaseThicknessNote", "id", "limeTreatedPavementSubgrade", "location", "moistureConditionedSubgrade", "moistureDepthNote", "name", "notes", "pavementAreaSf", "pavementNotes", "pavementSfPerTrip", "updatedAt") SELECT "buildingAreaSf", "createdAt", "docsReceived", "earthworkSfPerTrip", "flexibleBaseCap", "flexibleBaseThicknessNote", "id", "limeTreatedPavementSubgrade", "location", "moistureConditionedSubgrade", "moistureDepthNote", "name", "notes", "pavementAreaSf", "pavementNotes", "pavementSfPerTrip", "updatedAt" FROM "Project";
DROP TABLE "Project";
